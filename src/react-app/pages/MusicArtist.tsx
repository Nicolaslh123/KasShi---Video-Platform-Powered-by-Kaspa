...
import { 
  ...
  ChevronLeft, ChevronDown, Music2, Users, Loader2, Copy, Flag, Edit3, Palette, X, Trash2, Settings, Gift, Pencil, Star
} from 'lucide-react';
...
export default function MusicArtist() {
  ...
  // Get the theme to display - artist's profile theme takes priority
  ...
  const profileTheme = artist ? themes.find(t => t.id === activeThemeId) || themes.find(t => t.id === 'moonlight') || themes[0] : userTheme;
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 mt-6 sm:mt-10">
          ...
          {showManageContent && (
            <div className="space-y-6">
              ...
              {/* Empty state */}
              {allTracks.length === 0 && allPodcasts.length === 0 && (
                <div className="rounded-2xl p-[1px]" style={{ background: `linear-gradient(135deg, ${profileTheme.accent}40 0%, transparent 50%, ${profileTheme.accent}20 100%)` }}>
