...
// Minimum change to create a separate output - below this, add it to fee to avoid KIP-9 dust issues
// KIP-9 storage mass only becomes problematic for very small outputs (< 0.01 KAS)
// Using 0.05 KAS as a safe threshold that still returns most change to users
const MIN_CHANGE_SOMPI = 5000000; // 0.05 KAS
