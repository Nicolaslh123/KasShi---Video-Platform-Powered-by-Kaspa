...
export default function EditVideo() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      navigate(localizedPath(`/video/watch/${videoId}`));
    } catch (error) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      navigate(localizedPath(`/video/channel/${channel?.handle}`));
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-slate-900">
        ...
        <div className="flex flex-col items-center justify-center h-[calc(100vh-64px)] gap-4">
          ...
          <LocalizedLink to="/video" className="text-teal-400 hover:underline">
    ...
    return (
      <div className="min-h-screen bg-slate-900">
        ...
        <div className="flex flex-col items-center justify-center h-[calc(100vh-64px)] gap-4">
          ...
          <LocalizedLink to={`/video/watch/${videoId}`} className="text-teal-400 hover:underline">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Video Price - hidden for clips (clips are always free) and members-only videos */}
            {!video.isClip && !isMembersOnly && (
