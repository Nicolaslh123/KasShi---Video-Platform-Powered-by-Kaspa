...
import { ArrowLeft, Shield, FileText, Scale, AlertTriangle, Mail, PieChart } from "lucide-react";
import { KasShiLogo } from "../components/KasShiLogo";

type LegalSection = "privacy" | "terms" | "disclaimer" | "dmca" | "cookies" | "fractional-agreement";
...
const sections: { id: LegalSection; name: string; icon: typeof Shield }[] = [
  ...
  { id: "fractional-agreement", name: "Artist/Investor Agreement", icon: PieChart },
];
...
export default function Legal() {
  ...
  // Handle direct navigation to /legal/fractional-agreement
  useEffect(() => {
    if (location.pathname.includes("fractional-agreement")) {
      setActiveSection("fractional-agreement");
    }
  }, [location.pathname]);
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-950 via-teal-950 to-slate-950">
      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-white/5 border-b border-white/10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center gap-4">
          <LocalizedLink to="/video" className="p-2 rounded-lg hover:bg-white/10 transition-colors">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="prose prose-invert max-w-none">
          <div className="p-6 sm:p-8 rounded-2xl bg-white/5 border border-white/10">
            ...
            {activeSection === "fractional-agreement" && <FractionalAgreement />}
          </div>
        </div>
...
function FractionalAgreement() {
  return (
    <div className="space-y-6 text-white/80">
      <h2 className="text-2xl font-bold text-white">Artist/Investor Agreement — Track Fractionalization</h2>
      
      <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/30 text-amber-200">
        <p className="font-semibold mb-2">⚠️ HIGH-RISK SPECULATIVE INVESTMENT</p>
        <p className="text-sm">
          Purchasing shares in a fractionalized track is a speculative purchase of future platform earnings only. 
          There are no guarantees of returns. This is not financial advice. Please read this agreement carefully before proceeding.
        </p>
      </div>
      ...
      <section>
        ...
        <p>
          Track fractionalization on KasShi allows artists to sell a percentage (up to 40%) of their future platform earnings 
          from a specific track to investors ("shareholders"). This agreement governs the relationship between artists who 
          fractionalize their tracks and investors who purchase shares.
        </p>
      </section>

      <section>
        <h3 className="text-xl font-semibold text-white mb-3">2. What You Are Purchasing</h3>
        <p className="mb-2">When you buy shares in a fractionalized track, you are purchasing:</p>
        <ul className="list-disc list-inside space-y-1 ml-4">
          <li>A proportional claim to the artist's platform earnings from that specific track</li>
          <li>Earnings include: play revenue, tips, and any other platform-generated income for that track</li>
          <li>Shares are represented by KRC-20 tokens on the Kaspa blockchain</li>
        </ul>
        <p className="mt-3 text-amber-300">
          You are NOT purchasing: ownership of the song, copyright, royalties from other platforms, 
          merchandise rights, or any rights outside of KasShi platform earnings.
        </p>
      </section>

      <section>
        <h3 className="text-xl font-semibold text-white mb-3">3. Artist Obligations</h3>
        <p className="mb-2">Artists who fractionalize their tracks agree to:</p>
        <ul className="list-disc list-inside space-y-1 ml-4">
          <li>Not delete the fractionalized track (tracks are permanently locked)</li>
          <li>Not re-upload the exact same audio to circumvent shareholder claims</li>
          <li>Allow automatic distribution of shareholder earnings when payouts are processed</li>
        </ul>
        <p className="mt-3 text-white/60">
          However, artists have NO obligation to promote, market, or continue creating content. 
          Earnings depend entirely on organic listener engagement.
        </p>
      </section>

      <section>
        <h3 className="text-xl font-semibold text-white mb-3">4. Investor Risks</h3>
        <p className="mb-2">By purchasing shares, you acknowledge and accept:</p>
        <ul className="list-disc list-inside space-y-2 ml-4">
          <li><strong>No Guaranteed Returns:</strong> The track may generate zero earnings. The artist may stop promoting entirely.</li>
          <li><strong>Platform Risk:</strong> KasShi may modify fee structures, payout timing, or cease operations.</li>
          <li><strong>Liquidity Risk:</strong> There is no secondary market for shares. You may not be able to sell your shares.</li>
          <li><strong>Technical Risk:</strong> Blockchain transactions, smart contracts, or platform systems may have bugs or failures.</li>
          <li><strong>Regulatory Risk:</strong> Securities regulations may change and affect the legality or operation of this system.</li>
        </ul>
      </section>

      <section>
        <h3 className="text-xl font-semibold text-white mb-3">5. Payout Distribution</h3>
        <p className="mb-2">Shareholder payouts work as follows:</p>
        <ul className="list-disc list-inside space-y-1 ml-4">
          <li>When a fractionalized track earns KAS from plays or purchases, the earnings are split</li>
          <li>Artists receive their retained percentage (minimum 60%)</li>
          <li>Shareholders receive their proportional share of the sold percentage</li>
          <li>Payouts are processed automatically and recorded on-chain</li>
          <li>Payout frequency may vary based on platform operations and gas costs</li>
        </ul>
      </section>

      <section>
        <h3 className="text-xl font-semibold text-white mb-3">6. KRC-20 Token Representation</h3>
        <p>
          Shares are represented as KRC-20 tokens on the Kaspa blockchain. The ticker symbol is auto-generated 
          and unique to each fractionalized track. Token transfers are subject to Kaspa network fees and limitations.
          The platform records share ownership both on-chain and in its internal database for payout purposes.
        </p>
      </section>

      <section>
        <h3 className="text-xl font-semibold text-white mb-3">7. No Refunds</h3>
        <p>
          All share purchases are final. Once you purchase shares, you cannot request a refund. 
          The KAS you pay goes to the artist (minus platform fees). This is a permanent transaction.
        </p>
      </section>

      <section>
        <h3 className="text-xl font-semibold text-white mb-3">8. Platform Fees</h3>
        <p>
          KasShi may charge fees on initial share purchases and/or on earnings distributions. 
          Current fee structures are displayed during the purchase flow. Fees are subject to change with notice.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Any disputes between artists and investors regarding fractionalized tracks will be handled 
          according to the platform's Terms of Service. KasShi acts as a neutral platform and does not 
          guarantee any outcomes or mediate disputes beyond enforcing recorded share ownership.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          By clicking "Continue" or "Confirm" on the fractionalization or share purchase modals, 
          you confirm that you have read, understood, and agree to this Artist/Investor Agreement.
          You acknowledge the high-risk nature of this investment and confirm you are not relying on 
          any representations not explicitly stated in this agreement.
        </p>
      </section>

      <section className="border-t border-white/10 pt-6 mt-8">
        <p className="text-white/50 text-sm">
          This agreement is effective as of January 2025 and applies to all track fractionalizations 
          and share purchases on the KasShi platform. For questions, contact{" "}
          <a href="mailto:legal@kasshi.io" className="text-teal-400 hover:underline">legal@kasshi.io</a>.
        </p>
      </section>
    </div>
  );
