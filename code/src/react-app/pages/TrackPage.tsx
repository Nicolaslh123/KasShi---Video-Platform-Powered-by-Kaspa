      ...
      <div className={`relative z-10 max-w-4xl mx-auto px-4 py-8 ${isPlayerVisible ? 'pb-32' : ''}`}>
        ...
        <div className="relative p-[2px] rounded-2xl bg-gradient-to-br from-white/30 via-white/10 to-white/30">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            {/* Fractionalization info for investors */}
            {track.isFractionalized && (
              <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-xl text-xs">
                <span className="font-medium text-amber-900">🔥 This track is fractionalized.</span><br />
                <span className="text-amber-800">{((track.fractionalPercentageSold || 0) * 100).toFixed(0)}% of all future KAS tips/plays go to shareholders.</span><br />
                <span className="text-amber-700">High risk • No guarantees • Artist can stop uploading</span>
              </div>
            )}
          </div>
        </div>
