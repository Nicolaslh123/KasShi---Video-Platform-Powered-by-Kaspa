              ...
              <div key={membership.id} className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <LocalizedLink
                        to={`/video/channel/${membership.channelHandle}`}
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-white/50 text-sm">
                    ...
                    <LocalizedLink to={`/video/channel/${referralProgress.referrerHandle}`} className="text-amber-400 hover:underline">
          ...
          <div className="p-4 sm:p-6 rounded-2xl bg-white/5 border border-white/10">
            ...
            {referralStats && !referralStats.isEligible ? (
              ...
              <div className="p-4 bg-slate-800/50 rounded-xl text-center">
                ...
                <button
                  onClick={() => navigate(localizedPath('/video/upload'))}
